...
void VSOTelescope::globalToReflector_pos(Physics::Vec3D& v) const
{
...
void VSOTelescope::globalToReflector_mom(Physics::Vec3D& v) const
{
  // Rotate coordinate system to reflector orientation
  v.Rotate(-fRotationVector);
}

void VSOTelescope::reflectorToGlobal_pos(Physics::Vec3D& v) const
{
...
void VSOTelescope::reflectorToGlobal_mom(Physics::Vec3D& v) const
{
