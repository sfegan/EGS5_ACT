...
#define PC_CGS_L        1.0e+02                            // CGS length    per SI unit
#define PC_CGS_M        1.0e+03                            // CGS mass      per SI unit
#define PC_CGS_T        1.0e+00                            // CGS time      per SI unit

#define PC_CGS_L2       (PC_CGS_L*PC_CGS_L)                // CGS length^2  per SI unit
#define PC_CGS_L3       (PC_CGS_L2*PC_CGS_L)               // CGS length^3  per SI unit
#define PC_CGS_M2       (PC_CGS_M*PC_CGS_M)                // CGS mass^2    per SI unit
#define PC_CGS_M3       (PC_CGS_M2*PC_CGS_M)               // CGS mass^3    per SI unit
#define PC_CGS_T2       (PC_CGS_T*PC_CGS_T)                // CGS time^2    per SI unit
#define PC_CGS_T3       (PC_CGS_T2*PC_CGS_T)               // CGS time^3    per SI unit
#define PC_CGS_V        (PC_CGS_L/PC_CGS_T)                // CGS velocity  per SI unit
#define PC_CGS_F        (PC_CGS_M*PC_CGS_L/PC_CGS_T2)      // CGS force     per SI unit
#define PC_CGS_E        (PC_CGS_F*PC_CGS_L)                // CGS energy    per SI unit
#define PC_CGS_Q        2.99792458e+09                     // CGS charge    per SI unit - |c/(m/s)|*10
#define PC_CGS_FLUX     (1.0/PC_CGS_L2/PC_CGS_T)           // CGS flux      per SI unit - (i.e. 1/cm^2/s)
#define PC_CGS_E_FLUX   (PC_CGS_E/PC_CGS_L2/PC_CGS_T)      // CGS energy fl per SI unit - (i.e. erg/cm^2/s)

#define PC_SI_C         2.99792458e+08                     // vacuum speed of light              [m/s]
#define PC_SI_MU0       (4.0*M_PI*1e-7)                    // magnetic flux                    [N/A^2]
#define PC_SI_EPSILON0  (1.0/(PC_SI_MU0*PC_SI_C*PC_SI_C))  // electric flux                      [F/m]
#define PC_SI_C_ERR     0.00000000e+08                     // vacuum speed of light              [m/s]
#define PC_SI_H         6.6260693e-34                      // Plank                              [J s]
#define PC_SI_H_ERR     0.0000011e-34                      // Plank                              [J s]
#define PC_SI_HBAR      (PC_SI_H/2.0/M_PI)                 // h / 2pi                            [J s]
#define PC_SI_HBAR_ERR  (PC_SI_H_ERR/2.0/M_PI)             // h / 2pi                            [J s]
#define PC_SI_G         6.6742e-11                         // grav                        [m^3/kg/s^2]
#define PC_SI_G_ERR     0.0010e-11                         // grav                        [m^3/kg/s^2]
#define PC_SI_E         1.60217653e-19                     // electric charge unit                 [C]
#define PC_SI_E_ERR     0.00000014e-19                     // electric charge unit                 [C]
#define PC_SI_K         1.3806505e-23                      // Boltzmann                          [J/K]
#define PC_SI_K_ERR     0.0000024e-23                      // Boltzmann                          [J/K]
#define PC_SI_SIGMA     5.670400e-8                        // Stefan-Boltzmann             [W/m^2/K^4]
#define PC_SI_SIGMA_ERR 0.000040e-8                        // pi^2 k^4/60 hbar^3 c^2       [W/m^2/K^4]

#define PC_SI_AMU       1.66053886e-27                     // amu-mass                            [kg]
#define PC_SI_AMU_ERR   0.00000028e-27                     // amu-mass                            [kg]
#define PC_SI_EV        1.60217653e-19                     // 1 eV                                 [J]
#define PC_SI_EV_ERR    0.00000014e-19                     // 1 eV                                 [J]

#define PC_SI_E_MASS     9.1093826e-31                     // e-mass                              [kg]
#define PC_SI_E_MASS_ERR 0.0000016e-28                     // e-mass                              [kg]
#define PC_SI_P_MASS     1.67262171e-27                    // p-mass                              [kg]
#define PC_SI_P_MASS_ERR 0.00000029e-24                    // p-mass                              [kg]

#define PC_SI_TROPICAL_YEAR 3.15569260e+07                 // tropical year                        [s]
#define PC_SI_JULIAN_YEAR   3.15576e+07                    // julian year                          [s]

#define PC_SI_AU         1.4959787e+11                     // astronomical unit                    [m]
#define PC_SI_LIGHTYEAR  (PC_SI_C*PC_SI_JULIAN_YEAR)       // light year                           [m]
#define PC_SI_PARSEC     3.0856776e+16                     // parsec                               [m]
#define PC_SI_SUN_MASS   1.9891e+30                        // solar mass                          [kg]
#define PC_SI_SUN_RADIUS 6.96e+8                           // solar radius                         [m]
#define PC_SI_SUN_LUMINOSITY 3.9e+26                       // solar luminosity                     [W]

namespace Physics
{
  /*! \class Constants
    \brief Useful physical constants in SI and CGS
  */
  ...
  public:
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double num_pi             = M_PI;                        // pi
    static const double num_e              = M_E;                         // base of natural log
    static const double num_ln_10          = M_LN10;                      // natural log of 10
    static const double num_log10_e        = M_LOG10E;                    // log base 10 of e
    static const double num_root_two       = M_SQRT2;                     // sqrt(2)
    static const double num_root_half      = M_SQRT1_2;                   // sqrt(0.5)

    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Unit conversion
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double cgs_L              = PC_CGS_L;                    // CGS length    per SI unit
    static const double cgs_M              = PC_CGS_M;                    // CGS mass      per SI unit
    static const double cgs_T              = PC_CGS_T;                    // CGS time      per SI unit

    static const double cgs_L2             = PC_CGS_L2;                   // CGS length^2  per SI unit
    static const double cgs_L3             = PC_CGS_L3;                   // CGS length^3  per SI unit
    static const double cgs_M2             = PC_CGS_M2;                   // CGS mass^2    per SI unit
    static const double cgs_M3             = PC_CGS_M3;                   // CGS mass^3    per SI unit
    static const double cgs_T2             = PC_CGS_T2;                   // CGS time^2    per SI unit
    static const double cgs_T3             = PC_CGS_T3;                   // CGS time^3    per SI unit
    static const double cgs_V              = PC_CGS_V;                    // CGS velocity  per SI unit
    static const double cgs_F              = PC_CGS_F;                    // CGS force     per SI unit
    static const double cgs_E              = PC_CGS_E;                    // CGS energy    per SI unit
    static const double cgs_Q              = PC_CGS_Q;                    // CGS charge    per SI unit - |c/(m/s)|*10
    static const double cgs_FLUX           = PC_CGS_FLUX;                 // CGS flux      per SI unit - (i.e. 1/cm^2/s)
    static const double cgs_E_FLUX         = PC_CGS_E_FLUX;               // CGS energy fl per SI unit - (i.e. erg/cm^2/s)

    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Constants and errors from NIST, Mohr and Taylor, 2002 (as included in comments above) 
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double num_avogadro       = 6.0221415e+23;               // avogadro                              [1/mol]
    static const double num_avogadro_err   = 0.0000010e+23;               // avogadro                              [1/mol]
    static const double num_alpha          = 7.297352568e-3;              // fine structure                            [1]
    static const double num_alpha_err      = 0.000000024e-3;              // fine structure                            [1]

    static const double si_c               = PC_SI_C;                     // vacuum speed of light                   [m/s]
    static const double si_mu0             = PC_SI_MU0;                   // magnetic flux                         [N/A^2]
    static const double si_epsilon0        = PC_SI_EPSILON0;              // electric flux                           [F/m]
    static const double si_c_err           = PC_SI_C_ERR;                 // vacuum speed of light                   [m/s]
    static const double si_h               = PC_SI_H;                     // Plank                                   [J s]
    static const double si_h_err           = PC_SI_H_ERR;                 // Plank                                   [J s]
    static const double si_hbar            = PC_SI_HBAR;                  // h / 2pi                                 [J s]
    static const double si_hbar_err        = PC_SI_HBAR_ERR;              // h / 2pi                                 [J s]
    static const double si_G               = PC_SI_G;                     // grav                             [m^3/kg/s^2]
    static const double si_G_err           = PC_SI_G_ERR;                 // grav                             [m^3/kg/s^2]
    static const double si_e               = PC_SI_E;                     // electric charge unit                      [C]
    static const double si_e_err           = PC_SI_E_ERR;                 // electric charge unit                      [C]
    static const double si_k               = PC_SI_K;                     // Boltzmann                               [J/K]
    static const double si_k_err           = PC_SI_K_ERR;                 // Boltzmann                               [J/K]
    static const double si_sigma           = PC_SI_SIGMA;                 // Stefan-Boltzmann                  [W/m^2/K^4]
    static const double si_sigma_err       = PC_SI_SIGMA_ERR;             // pi^2 k^4/60 hbar^3 c^2            [W/m^2/K^4]
    
    static const double cgs_c              = PC_SI_C*PC_CGS_V;            // vacuum speed of light                  [cm/s]
    static const double cgs_c_err          = PC_SI_C_ERR*PC_CGS_V;        // vacuum speed of light                  [cm/s]
    static const double cgs_h              = PC_SI_H*PC_CGS_E/PC_CGS_T;   // Plank                                 [erg s]
    static const double cgs_h_err          = PC_SI_H_ERR*PC_CGS_E/PC_CGS_T;// Plank                                [erg s]
    static const double cgs_hbar           = PC_SI_H*PC_CGS_E/PC_CGS_T;   // h / 2pi                               [erg s]
    static const double cgs_hbar_err       = PC_SI_H_ERR*PC_CGS_E/PC_CGS_T;// h / 2pi                              [erg s]
    static const double cgs_G              = PC_SI_G*PC_CGS_L3/PC_CGS_M/PC_CGS_T2; // grav                    [cm^3/g/s^2]
    static const double cgs_G_err          = PC_SI_G_ERR*PC_CGS_L3/PC_CGS_M/PC_CGS_T2; //  grav               [cm^3/g/s^2]
    static const double cgs_e              = PC_SI_E*PC_CGS_Q;            // electric charge unit                    [esu]
    static const double cgs_e_err          = PC_SI_E_ERR*PC_CGS_Q;        // electric charge unit                    [esu]
    static const double cgs_k              = PC_SI_K*PC_CGS_E;            // Boltzmann                             [erg/K]
    static const double cgs_k_err          = PC_SI_K_ERR*PC_CGS_E;        // Boltzmann                             [erg/K]
    static const double cgs_sigma          = PC_SI_SIGMA*PC_CGS_E/PC_CGS_L2; // Stefan-Boltzmann            [erg/cm^2/K^4]
    static const double cgs_sigma_err      = PC_SI_SIGMA_ERR*PC_CGS_E/PC_CGS_L2; // pi^2 k^4/60 hbar^3 c^2      [as above]

    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Unit conversion constants
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double si_amu             = PC_SI_AMU;                   // amu-mass                                 [kg]
    static const double si_amu_err         = PC_SI_AMU_ERR;               // amu-mass                                 [kg]
    static const double si_eV              = PC_SI_EV;                    // 1 eV                                      [J]
    static const double si_eV_err          = PC_SI_EV_ERR;                // 1 eV                                      [J]

    static const double cgs_amu            = PC_SI_AMU*PC_CGS_M;          // amu-mass                                  [g]
    static const double cgs_amu_err        = PC_SI_AMU_ERR*PC_CGS_M;      // amu-mass                                  [g]
    static const double cgs_eV             = PC_SI_EV*PC_CGS_E;           // 1 eV                                    [erg]
    static const double cgs_eV_err         = PC_SI_EV_ERR*PC_CGS_E;       // 1 eV                                    [erg]
    
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Particle properties
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double si_e_chg           = -PC_SI_E;                    // e-charge                                  [C]
    static const double si_e_chg_err       = PC_SI_E_ERR;                 // e-charge                                  [C]
    static const double si_e_mass          = PC_SI_E_MASS;                // e-mass                                   [kg]
    static const double si_e_mass_err      = PC_SI_E_MASS_ERR;            // e-mass                                   [kg]
    static const double si_p_chg           = PC_SI_E;                     // e-charge                                  [C]
    static const double si_p_chg_err       = PC_SI_E_ERR;                 // e-charge                                  [C]
    static const double si_p_mass          = PC_SI_P_MASS;                // p-mass                                   [kg]
    static const double si_p_mass_err      = PC_SI_P_MASS_ERR;            // p-mass                                   [kg]
 
    static const double cgs_e_chg          = -PC_SI_E*PC_CGS_Q;           // e-charge                                [esu]
    static const double cgs_e_chg_err      = PC_SI_E_ERR*PC_CGS_Q;        // e-charge                                [esu]
    static const double cgs_e_mass         = PC_SI_E_MASS*PC_CGS_M;       // e-mass                                    [g]
    static const double cgs_e_mass_err     = PC_SI_E_MASS_ERR*PC_CGS_M;   // e-mass                                    [g]
    static const double cgs_p_chg          = PC_SI_E*PC_CGS_Q;            // e-charge                                [esu]
    static const double cgs_p_chg_err      = PC_SI_E_ERR*PC_CGS_Q;        // e-charge                                [esu]
    static const double cgs_p_mass         = PC_SI_P_MASS*PC_CGS_M;       // p-mass                                    [g]
    static const double cgs_p_mass_err     = PC_SI_P_MASS_ERR*PC_CGS_M;   // p-mass                                    [g]

    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Astronomical constants
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static const double si_tropical_year   = PC_SI_TROPICAL_YEAR;         // tropical year                             [s]
    static const double si_julian_year     = PC_SI_JULIAN_YEAR;           // julian year                               [s]

    static const double cgs_tropical_year  = PC_SI_TROPICAL_YEAR*PC_CGS_T;// tropical year                             [s]
    static const double cgs_julian_year    = PC_SI_JULIAN_YEAR*PC_CGS_T;  // julian year                               [s]

    static const double si_au              = PC_SI_AU;                    // astronomical unit                         [m]
    static const double si_light_year      = PC_SI_LIGHTYEAR;             // light year                                [m]
    static const double si_parsec          = PC_SI_PARSEC;                // parsec                                    [m]
    static const double si_sun_mass        = PC_SI_SUN_MASS;              // solar mass                               [kg]
    static const double si_sun_radius      = PC_SI_SUN_RADIUS;            // solar radius                              [m]
    static const double si_sun_luminosity  = PC_SI_SUN_LUMINOSITY;        // solar luminosity                          [W]

    static const double cgs_au             = PC_SI_AU*PC_CGS_L;           // astrnomical unit                         [cm]
    static const double cgs_light_year     = PC_SI_LIGHTYEAR*PC_CGS_L;    // light year                               [cm]
    static const double cgs_parsec         = PC_SI_PARSEC*PC_CGS_L;       // parsec                                   [cm]
    static const double cgs_sun_mass       = PC_SI_SUN_MASS*PC_CGS_M;     // solar mass                                [g]
    static const double cgs_sun_radius     = PC_SI_SUN_RADIUS*PC_CGS_L;   // solar radius                             [cm]
    static const double cgs_sun_luminosity = PC_SI_SUN_LUMINOSITY*PC_CGS_E/PC_CGS_T; // solar luminosity           [erg/s]
  }; // class Constants
